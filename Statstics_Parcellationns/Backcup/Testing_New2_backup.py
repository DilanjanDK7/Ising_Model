...
def perform_group_analysis(correlation_df, output_folder):
    ...
    with open(log_file_path, 'w') as log_file:
        ...
        non_constant_columns = correlation_df_clean.var() > variance_threshold
        correlation_df_clean = correlation_df_clean.loc[:, non_constant_columns.index]

    # Descriptive statistics and visualizations for each comparison
    for types in correlation_df_clean.drop_duplicates(['Data Type 1', 'Data Type 2']).loc[:, ['Data Type 1', 'Data Type 2']].values:
