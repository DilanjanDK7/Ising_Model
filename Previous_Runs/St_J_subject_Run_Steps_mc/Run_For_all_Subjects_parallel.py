...
def process_files(fmri_path, pet_path, jij_path,subject_id,parcellation,base_output_folder):
    ...
    description_array = ['Optimal_Temperature', 'Optimal_Alpha', 'Parcellation', 'Subject','correlations','steps_mc']
    value_array = [optimised[0][0], optimised[0][1], parcellation, subject_id,optimised[1],optimised[0][2]]
...
base_output_folder = "/home/brainlab-qm/Desktop/5_node_Ising/Output_with_mu"
